  ...
  return (
    <div className="code-of-conduct">
      ...
      <Content
        ...
        title="Purpose"
      >
        <p>Front-End Party is dedicated to being inclusive to the largest number of people, with the most varied and diverse backgrounds possible. As such, we strive to provide a friendly, safe and welcoming environment for all, regardless of gender, gender identity and expression, sexual orientation, ability, physical appearance, body size, race, ethnicity, age, socioeconomic status, and religion (or lack thereof).</p>
        ...
        <p>We invite all those who participate in Front-End Party to help us create safe and positive experiences for everyone.</p>
      </Content>
      <Content
        emoji="&#127873;"
        title="Expected Behavior"
      >
        <p>The following behaviors are expected and requested of all community members, participants, and attendees:</p>
        <ul>
      ...
      >
        <p>Harassment is unacceptable within our community, including all participants and attendees. Harassment includes, but is not limited to:</p>
        <ul>
          ...
          <li>Unwelcome sexual attention. This includes, sexualized comments or jokes; inappropriate touching, groping, and unwelcome sexual advances.</li>
      ...
      >
        <p>No weapons will be allowed at Front-End Party events, community spaces, or in other spaces covered by the scope of this Code of Conduct. Weapons include but are not limited to guns, explosives (including fireworks), and large knives such as those used for hunting or display, as well as any other item used for the purpose of causing injury or harm to others. Anyone seen in possession of one of these items will be asked to leave immediately, and will only be allowed to return without the weapon. Community members are further expected to comply with all state and local laws on this matter.</p>
      </Content>
      <Content
        emoji="&#127752;"
      ...
      >
        ...
        <p>If any community member, participant, or attendee engages in unacceptable behavior, the community organizers may take any action they deem appropriate, up to and including a temporary ban or permanent expulsion from the community and/or event without warning (and without refund in the case of a paid event).</p>
      </Content>
      <Content
        emoji="&#127752;"
        title="Reporting"
      >
        <p>If you are subject to or witness unacceptable behavior, feel unsafe or unwelcome, or have any other concerns, please notify a community organizer as soon as possible by either directly contacting the organizers or filing an anonymous report:</p>
        <h3>Direct Reporting</h3>
        Directly contact one of the organizers in person or through Meetup’s messaging system:
        <ul>
          <li>Cameron Sampson https://www.meetup.com/FrontEndParty/members/52557152/</li>
          <li>Steven Achord https://www.meetup.com/FrontEndParty/members/185213572/</li>
          <li>Sia Karamalegos https://www.meetup.com/FrontEndParty/members/98819682/</li>
        </ul>
      ...
      >
        <p>Portions of text derived from the The Citizen Code of Conduct (http://citizencodeofconduct.org/), and JS Conf EU (https://2018.jsconf.eu/code-of-conduct/)</p>
      </Content>
    </div>
  );
};
